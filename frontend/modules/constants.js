...
export function createInitialTeacherStudents() {
    return [
        { id: "s1", name: "王语涵", studentId: "2024001", basic: { jobTarget: "Java开发", school: "杭州电子科技大学", major: "计算机科学与技术" }, gpa: "3.65", coreCourses: "数据结构, 数据库", internship: "阿里巴巴实习", project: "智能推荐系统", awards: "算法大赛二等奖" },
        { id: "s2", name: "李思睿", studentId: "2024002", basic: { jobTarget: "前端开发", school: "某某大学", major: "软件工程" }, gpa: "3.82", coreCourses: "Web开发, 操作系统", internship: "腾讯前端", project: "电商后台", awards: "数学建模省一" }
    ];
}
